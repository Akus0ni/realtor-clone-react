    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form >
            <input type="text" name="name" id="name" className='w-full px-4 py-2 text-xl text-gray-600 bg-white border-gray-300 rounded transition ease-in-out mb-6' value={name} onChange={onChange} placeholder="Full Name"/>

            <input type="email" name="email" id="email" className='w-full px-4 py-2 text-xl text-gray-600 bg-white border-gray-300 rounded transition ease-in-out mb-6' value={email} onChange={onChange} placeholder="Email Address"/>
            <div className='relative'>
              <input type={showPassword ? "text" : "password"} name="password" id="password" className='w-full px-4 py-2 text-xl text-gray-600 bg-white border-gray-300 rounded transition ease-in-out mb-6' value={password} onChange={onChange} placeholder="Password"/>
